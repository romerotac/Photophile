...
function Login({setIsAuth}){
    ...
    */
    ...
    const addUser = async () =>{
        await addDoc(postsCollectionRef, {id:auth.currentUser.uid,name: auth.currentUser.displayName,email:auth.currentUser.email,favoriteCamera:'',state:'', profileImgPath:'',social:{website:'',twitter:'',instagram:'',facebook:'',pinterest:''}});
